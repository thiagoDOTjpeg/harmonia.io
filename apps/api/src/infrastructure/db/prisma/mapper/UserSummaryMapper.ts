...
import { formatFullDate } from "@harmonia/shared";
...
export class UserSummaryMapper {
  static toDomain(summary: PrismaUserSummary): UserSummary {
    ...
    return {
      ...
      last_sync_at: formatFullDate(summary.lastSyncAt?.toISOString()),
      ...
      user_created_at: formatFullDate(summary.userCreatedAt.toISOString()),
